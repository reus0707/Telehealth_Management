	...
	<div class="col-md-12 graph-box1 clearfix">	
							<div class="grid-1">
								...
								<div class="grid-graph">
									...
									<div id="os-Win-lbl">黑龙江省<span>8</span></div>
									<div id="os-Mac-lbl">北京市<span>6</span></div>
									<div id="os-Other-lbl">天津市<span>3</span></div>
									<div id="os-server-lbl">福建省<span>1</span></div>
									<div id="os-lbl" class="os-lbl">辽宁省<span>2</span></div>
								 </div>
								 </div>
							<div class="grid-2">
								...
								<script>
									var pieData = [
										{
											value: 8/20,<%-- <s:property value="%{Description[#st.index]}"/> --%>
											color:"#D95459"
										},
										{
											value : 6/20,<%-- <s:property value="%{Description[#st.index]}"/> --%>
											color : "#1ABC9C"
										},
										{
											value : 3/20,<%-- <s:property value="%{Description[#st.index]}"/> --%>
											color : "#3BB2D0"
										},
										{
											value : 1/20,<%-- <s:property value="%{Description[#st.index]}"/> --%>
											color : "#FF8C00"
										},
										{
											value : 2/20,<%-- <s:property value="%{Description[#st.index]}"/> --%>
											color : "#666666"
										}
										,
										{
