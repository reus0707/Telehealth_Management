				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>答案管理设置有效与无效</span>
					</h2>
				</div>
				<!--//banner-->
				<!--grid-->
					...
					<div class="grid-form1">
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" action="AnswerVerify" method="post">
									<input type="hidden" name=userid value=<s:property value="user.userid"/> /> 
									<div class="form-group">
										<label for="disabledinput" class="col-sm-2 control-label">patientanswer_id</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1"
												id="focusedinput"
												name=patientanswer_id
												value="<s:property value="Ans.patientanswer_id"/>"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control1" id="focusedinput"
												name="real_name" value="<s:property value="Ans.patientname"/>"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control1" id="focusedinput"
												name="clinic" value="<s:property value="Ans.time"/>"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">病种类型</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" id="focusedinput"
												name="clinic" value="<s:property value="Ans.typedisease"/>"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">题目内容</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" id="focusedinput"
												name="clinic" value="<s:property value="Ans.question_content"/>"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">回答</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" id="focusedinput"
												name="clinic" value="<s:property value="Ans.answer_content"/>"
												readonly="readonly">
										</div>
									</div>
									...
									<div class="panel-footer">
										...
										<div class="row">
											<div class="col-sm-8 col-sm-offset-2">
												<button class="btn-primary btn">判断回答无效</button>
