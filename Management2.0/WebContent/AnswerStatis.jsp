				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>无效题目统计</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
					        ...
					        <div class="layui-card-body layui-form">
					            ...
					            <div class="layui-form">
										...
										<table class="layui-table">
											...
											<s:iterator value="AnswerStatisVect" var="Lend">
												<tr>
													<td>
														<div class="layui-btn-group">
															<div id="div11">
																<form action="QuestionVectSelect" method="post" >
																	<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																	<input type="hidden" name=question_id value=<s:property value="#Lend.question_id"/> />
																    <button class="layui-btn layui-btn-xs">管理</button>
																</form>
															</div>
														</div>
													</td>
													...
													<td><s:property value="#Lend.countsta" /></td>
