				...
				<ul class=" nav_1">
					...
					<!-- 
					 ...
					 -->
						...
						<a href="AssessAddJump?userid=<s:property value="user.userid"/>">
						+ 点击添加 &nbsp
						</a>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="content-main">
				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>评价信息管理</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
				<div class="blank">
					        ...
					        <div class="layui-card-body layui-form">
					        	<div style="display:inline">
						        	<div id="div1" style="float:left">
							            <form action="AssessQuery" method="post">
									...
									<div id="div1" style="float:right">
										<form action="AssessAddJump" method="post" >
											<input type="hidden" name=userid value=<s:property value="user.userid"/> />
					            ...
					            <div class="layui-form">
										...
										<table class="layui-table">
											...
											<s:iterator value="AssessVect" var="Lend">
												<tr>
													<td>
														<div class="layui-btn-group">
															
															<div id="div13">
																<form action="AssessDelete" method="post" >
																	<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																	<input type="hidden" name=assess_id value=<s:property value="#Lend.assess_id"/> />
																    <button class="layui-btn layui-btn-danger layui-btn-xs">删除</button>
																</form>
															</div>
														</div>
													</td>
													<td><s:property value="#Lend.assess_id" /></td>
													<td><s:property value="#Lend.doctorname" /></td>
													<td><s:property value="#Lend.patientname" /></td>
													
													<td><s:property value="#Lend.time" /></td>
													<td><s:property value="#Lend.content" /></td>
					...
					<ul class="pagination">
						<li><a
							href="AssessVectSelect?userid=<s:property value="user.userid"/>&page=0">&laquo;</a></li>
						<% for(int i=0;i<10;i++){ %>
						<li><a
							href="AssessVectSelect?userid=<s:property value="user.userid"/>&page=<%=i%>"><%=i%></a></li>
						<%}%>
