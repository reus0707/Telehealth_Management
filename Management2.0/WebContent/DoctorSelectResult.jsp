		...
		<div class="drop-men">
			<ul class=" nav_1">
				...
				<!-- 
				 ...
				 -->
					<a href="AssessVectSelect?userid=<s:property value="user.userid"/>">
					+ 评价管理 &nbsp
					</a>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="content-main">
				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>医生信息管理</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
				<div class="blank">
					        ...
					        <div class="layui-card-body layui-form">
					        	<div style="display:inline">
						        	<div id="div1" style="float:left">
							            <form action="DoctorQuery" method="post">
									...
									<div id="div1" style="float:right">
										<form action="AssessVectSelect" method="post" >
											<input type="hidden" name=userid value=<s:property value="user.userid"/> />
								            <button style="" id="btnAdd" type="submit" class="layui-btn icon-btn"><i class="layui-icon">&#xe615;</i>评价管理</button>
										</form>
									</div>
									<div id="div1" style="float:right; margin-right:1em;" >
										<form action="AddPatientJump" method="post" >
											<input type="hidden" name=userid value=<s:property value="user.userid"/> />
								            <button style="" id="btnAdd" type="submit" class="layui-btn icon-btn"><i class="layui-icon">&#xe654;</i>点击添加</button>
										</form>
									</div>
								</div>
					            ...
					            <div class="layui-form">
										<table class="layui-table">
											...
											<s:iterator value="DoctorVect" var="Lend">
												<tr>
													<td>
														
														<div class="layui-btn-group">
															<div id="div11">
															<form action="DoctorSelect" method="post" >
																<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																<input type="hidden" name=doctor_id value=<s:property value="#Lend.doctor_id"/> />
															              <button class="layui-btn layui-btn-xs">修改</button>
															</form>
															</div>
															
															<div id="div12">
															<form action="DoctorVerifyJump" method="post" >
																<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																<input type="hidden" name=doctor_id value=<s:property value="#Lend.doctor_id"/> />
													...
													<td><s:property value="#Lend.doctor_id" /></td>
													<td><s:property value="#Lend.real_name" /></td>
													<td><s:property value="#Lend.sex" /></td>
													<td><s:property value="#Lend.age" /></td>
													
													<td><s:property value="#Lend.clinic" /></td>
													<td><s:property value="#Lend.department" /></td>
													<td><s:property value="#Lend.address" /></td>
													<td><s:property value="#Lend.phone" /></td>
													<td><s:property value="#Lend.email" /></td>
													
													<td><s:property value="#Lend.birthday" /></td>
													
													<td><s:property value="#Lend.insuranceget" /></td>
													<td><s:property value="#Lend.introduction" /></td>
													
													<td><s:property value="#Lend.username" /></td>
													<td><s:property value="#Lend.password" /></td>
													<td><s:property value="#Lend.real_id" /></td>
													
													<td><s:property value="#Lend.verificationcode" /></td>
													<td><s:property value="#Lend.sta" />
					...
					<ul class="pagination">
						<li><a
							href="DoctorVectSelect?userid=<s:property value="user.userid"/>&page=0">&laquo;</a></li>
						<% for(int i=0;i<10;i++){ %>
						<li><a
							href="DoctorVectSelect?userid=<s:property value="user.userid"/>&page=<%=i%>"><%=i%></a></li>
						<%}%>
