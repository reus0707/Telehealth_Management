				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>Retirment</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
					...
					<div class="blank-page">
						<form class="form" action="RetireManage" method="post">
							<input type="hidden" name=userid
								value=<s:property value="user.userid"/> /> <input type="hidden"
								name=LendEqu value=<s:property value="Cp.EquName"/> /> <input
								type="hidden" name=LendNumber
								value=<s:property value="Cp.EquNumber"/> /> <br>
							<label for="id_LendEqu">设备名称:</label>
							<s:property value="Cp.EquName" />
							</br> <br>
							<label for="id_Lendnumber">设备编号:</label>
							<s:property value="Cp.EquNumber" />
							</br> <br>
							<textarea rows="20" cols="50" name="application" required
								id="id_application" placeholder="在此输入报废申请，管理员核实后会通知"></textarea>
							</br> <br>
							<input type="submit" value="post" class="text-sub"></br>
						</form>
					</div>
				</div>
