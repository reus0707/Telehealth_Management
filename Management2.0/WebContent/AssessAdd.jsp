  ...
  <div class="grid-form1">
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AssessAdd" method="post" >
							 	<input type="hidden" name=userid value=<s:property value="user.userid"/> /> 

								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">医生ID</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="doctor_id">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">患者ID</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="patient_id">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">医生姓名</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="doctorname">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">评价内容</label>
									<div class="col-sm-8">
										<textarea rows="4" cols="25"  name="content" id="focusedinput">
										</textarea>
									</div>
								</div>
