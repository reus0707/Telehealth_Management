								...
								<s:iterator value="Cpt" var="cs">
									...
									<table>
										...
										<tr>
											<td>Manufacturer</td>
											<td>:</td>
											<td><s:property value="#cs.Manufacturer" /></td>
										</tr>

										<tr>
											<td>Supplier</td>
											<td>:</td>
											<td><s:property value="#cs.Supplier" /></td>
										</tr>

										<tr>
											<td>Specifications</td>
											<td>:</td>
											<td><s:property value="#cs.Specifications" /></td>
										</tr>

										<tr>
											<td>OrderDate</td>
											<td>:</td>
											<td><s:property value="#cs.OrderDate" /></td>
										</tr>

										<tr>
											<td>Inspector</td>
											<td>:</td>
											<td><s:property value="#cs.Inspector" /></td>
										</tr>
										...
										<tr>
											<td>Maintainer</td>
											<td>:</td>
											<td><s:property value="#cs.Maintainer" /></td>
										</tr>

										<tr>
											<td>InventoryPosition</td>
											<td>:</td>
											<td><s:property value="#cs.InventoryPosition" /></td>
										</tr>

										<tr>
											<td>PresentPosition</td>
											<td>:</td>
											<td><s:property value="#cs.PresentPosition" /></td>
										</tr>
