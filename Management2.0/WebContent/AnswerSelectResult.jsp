			...
			<ul class=" nav_1">
				...
				<!-- 
				 ...
				 -->
					...
					<a href="AnswerStatis?userid=<s:property value="user.userid"/>">
					+ 查看统计 &nbsp
					</a>
					<a href="AnswerAddJump?userid=<s:property value="user.userid"/>">
					+ 点击添加 &nbsp
					</a>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="content-main">
				...
				<div class="blank">
					        ...
					        <div class="layui-card-body layui-form">
					        	<div style="display:inline">
									...
									<div id="div1" style="float:right">
										<form action="AnswerStatis" method="post" >
											<input type="hidden" name=userid value=<s:property value="user.userid"/> />
								            <button style="" id="btnSearch" type="submit" class="layui-btn icon-btn"><i class="layui-icon">&#xe615;</i>无效题目统计</button>
										</form>
									</div>
									<div id="div1" style="float:right; margin-right:1em;" >
										<form action="AnswerAddJump" method="post" >
											<input type="hidden" name=userid value=<s:property value="user.userid"/> />
								            <button style="" id="btnAdd" type="submit" class="layui-btn icon-btn"><i class="layui-icon">&#xe654;</i>答题录入</button>
										</form>
									</div>
								</div>
					            ...
					            <div class="layui-form">
										...
										<table class="layui-table">
											...
											<s:iterator value="AnswerVect" var="Lend">
												<tr>
													<td>
														<div class="layui-btn-group">
															<div id="div11">
																<form action="AnswerVerifyJump" method="post" >
																	<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																	<input type="hidden" name=patientanswer_id value=<s:property value="#Lend.patientanswer_id"/> />
																    <button class="layui-btn layui-btn-xs">判定</button>
																</form>
															</div>
													...
													<td><s:property value="#Lend.patientanswer_id" /></td>
										
													<td><s:property value="#Lend.question_id" /></td>
													<td><s:property value="#Lend.patientname" /></td>
													<td><s:property value="#Lend.question_content" /></td>
													<td><s:property value="#Lend.answer_content" /></td>
													<td><s:property value="#Lend.time" /></td>
													
													<td><s:property value="#Lend.typedisease" /></td>
					...
					<ul class="pagination">
						<li><a
							href="AnswerVectSelect?userid=<s:property value="user.userid"/>&page=0">&laquo;</a></li>
						<% for(int i=0;i<10;i++){ %>
						<li><a
							href="AnswerVectSelect?userid=<s:property value="user.userid"/>&page=<%=i%>"><%=i%></a></li>
						<%}%>
