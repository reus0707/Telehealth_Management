		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="content-main">
				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>电子病历管理</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
				<div class="blank">
					        ...
					        <div class="layui-card-body layui-form">
					        	<div style="display:inline">
						        	<div id="div1" style="float:left">
							            <form action="CaseQuery" method="post">
					            ...
					            <div class="layui-form">
										...
										<table class="layui-table">
											...
											<s:iterator value="CaseVect" var="Lend">
												<tr>
													<td>
														<div class="layui-btn-group">
															<div id="div11">
																<form action="CaseSelect" method="post" >
																	<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																	<input type="hidden" name=case_id value=<s:property value="#Lend.case_id"/> />
																    <button class="layui-btn layui-btn-primary layui-btn-xs">查看</button>
																</form>
															</div>
															
															<div id="div13">
																<form action="CaseDelete" method="post" >
																	<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																	<input type="hidden" name=case_id value=<s:property value="#Lend.case_id"/> />
													...
													<td><s:property value="#Lend.case_id" /></td>
										
													<td><s:property value="#Lend.patient_id" /></td>
													<td><s:property value="#Lend.patientname" /></td>
													<td><s:property value="#Lend.patientsex" /></td>
													<td><s:property value="#Lend.patientage" /></td>
													
													<td><s:property value="#Lend.department" /></td>
													
													<td><s:property value="#Lend.doctor_id" /></td>
													<td><s:property value="#Lend.doctorname" /></td>
													<td><s:property value="#Lend.doctorsex" /></td>
													<td><s:property value="#Lend.doctorage" /></td>
													
													<td><s:property value="#Lend.description" /></td>
					...
					<ul class="pagination">
						<li><a
							href="CaseVectSelect?userid=<s:property value="user.userid"/>&page=0">&laquo;</a></li>
						<% for(int i=0;i<10;i++){ %>
						<li><a
							href="CaseVectSelect?userid=<s:property value="user.userid"/>&page=<%=i%>"><%=i%></a></li>
						<%}%>
