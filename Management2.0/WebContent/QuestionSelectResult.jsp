			...
			<ul class=" nav_1">
				...
				<!-- 
				 ...
				 -->
					...
					<a href="QuestionAddJump?userid=<s:property value="user.userid"/>">
					+ 点击添加 &nbsp
					</a>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="content-main">
				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>科室问题管理</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
				<div class="blank">
					        ...
					        <div class="layui-card-body layui-form">
					        	<div style="display:inline">
						        	<div id="div1" style="float:left">
							            <form action="QuestionQuery" method="post">
									...
									<div id="div1" style="float:right">
										<form action="QuestionAddJump" method="post" >
											<input type="hidden" name=userid value=<s:property value="user.userid"/> />
								            <button style="" id="btnAdd" type="submit" class="layui-btn icon-btn"><i class="layui-icon">&#xe654;</i>添加问题</button>
										</form>
									</div>
								</div>
					            ...
					            <div class="layui-form">
										...
										<table class="layui-table">
											...
											<s:iterator value="QuestionVect" var="Lend">
												<tr>
													<td>
														<div class="layui-btn-group">
															<div id="div13">
																<form action="QuestionDelete" method="post" >
																	<input type="hidden" name=userid value=<s:property value="user.userid"/> />
																	<input type="hidden" name=question_id value=<s:property value="#Lend.question_id"/> />
													...
													<td><s:property value="#Lend.question_pre" /></td>
					...
					<ul class="pagination">
						<li><a
							href="QuestionVectSelect?userid=<s:property value="user.userid"/>&page=0">&laquo;</a></li>
						<% for(int i=0;i<10;i++){ %>
						<li><a
							href="QuestionVectSelect?userid=<s:property value="user.userid"/>&page=<%=i%>"><%=i%></a></li>
						<%}%>
