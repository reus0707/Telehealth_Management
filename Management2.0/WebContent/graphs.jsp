		...
		<button style="" id="btnSearch" type="submit" class="layui-btn icon-btn" ><i class="layui-icon">&#xe615;</i>搜索</button>
							<div class="grid-1">
								...
								<div class="grid-graph">
									...
									<div id="os-Win-lbl">感冒<span>8</span></div>
									<div id="os-Mac-lbl">发烧<span>6</span></div>
									<div id="os-Other-lbl">牙科病<span>3</span></div>
									<div id="os-server-lbl">骨科病<span>1</span></div>
									<div id="os-lbl" class="os-lbl">妇科病<span>2</span></div>
								 </div>
								 </div>
							<div class="grid-2">
