				...
				<div class="blank">
					...
					<div class="blank-page">
						<form class="form" action="" method="post">
							...
							<div class="readed">
								<a
									href="AdminRead?userid=<s:property value="user.userid"/>&type=0"><b>Readed</b></a>
							</div>
							<div class="blank2"></div>
							<div class="unread">
								<a
									href="AdminRead?userid=<s:property value="user.userid"/>&type=1"><b>Unread</b></a>
							</div>
							...
							<table class="hovertable">
								...
								<s:iterator value="lend" var="Lend">
									<tr onmouseover="this.style.backgroundColor='#fdf5e6';"
										...
										<td><a
											href="CsSelect?userid=<s:property value="user.userid"/>&EquNumber=<s:property value="#Lend.LendNumber"/>"><s:property
										...
										<td><a
											href="view?userid=<s:property value="user.userid"/>&EquNumber=<s:property value="#Lend.LendNumber"/>&type=1">View</a>
									</tr>
								</s:iterator>
							</table>
						</form>
