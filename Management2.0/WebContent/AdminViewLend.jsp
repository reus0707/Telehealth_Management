...
<html>
<head>
<title>Admin view Lend Application</title>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#" class=" hvr-bounce-to-right"><i
							class="fa fa-list nav_icon"></i> <span class="nav-label">Select</span><span
							class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><s:a action="SelectHome">
									<s:param name="userid">
							...
							<div class="col-md-8 profile-text">
								...
								<table>
									...
									<tr>
										<td>EquName</td>
										<td>:</td>
										<td><s:property value="Le.EquName" /></td>
									</tr>
									<tr>
										<td>Applicant</td>
										<td>:</td>
									...
									<tr>
										<td>LendUnit</td>
										<td>:</td>
										<td><s:property value="Le.LendUnit" /></td>
									</tr>
									...
									<tr>
										<td>ApplicationDate1</td>
										<td>:</td>
										<td><s:property value="Le.ApplicationDate1" /></td>
									</tr>

									<tr>
										<td>ApplicationDate2</td>
										<td>:</td>
									...
									<tr>
										<td>Application</td>
										<td>:</td>
										<td><s:property value="Le.Application" /></td>
									</tr>
										...
										<td>
											<form class="text-sub" action="AgreeLend" method="post">
												<input type="hidden" name=userid
													...
													value=<s:property value="Le.LendNumber"/> /> <input
													type="hidden" name=UnitLend
													value=<s:property value="Le.UnitLend"/> /> <input
