							...
							<table class="hovertable">
								...
								<s:iterator value="lend" var="Lend">
									<tr onmouseover="this.style.backgroundColor='#fdf5e6';"
										...
										<td><a
											href="UserReturn?userid=<s:property value="user.userid"/>&EquNumber=<s:property value="#Lend.LendNumber"/>&page=0&UnitLend=<s:property value="#Lend.LendUnit"/>">return</a></td>
									</tr>
								</s:iterator>
							</table>
						</form>
