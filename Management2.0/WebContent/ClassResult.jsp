	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="content-main">
				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>Class Result</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
				<div class="blank">
					<form class="form"
						action="ComeputerHome?EquClass=<s:property value="EquClass"/>"
						method="post">
						<div class="input-group input-group-in">
							<input type="text" name="Aim" class="form-control2 input-search"
								...
								type="hidden" name=year value=<s:property value="year"/> /> <span
					...
					<ul class="pagination">
						<li><a
							href="ComputerHome?userid=<s:property value="user.userid"/>&EquClass=<s:property value="EquClass"/>&year=<s:property value="year"/>&page=0">&laquo;</a></li>
						<% for(int i=0;i<10;i++){ %>
						<li><a
							href="ComputerHome?userid=<s:property value="user.userid"/>&EquClass=<s:property value="EquClass"/>&year=<s:property value="year"/>&page=<%=i%>"><%=i%></a></li>
						<%}%>
