					...
					<div class="col-md-7 mid-content-top">
						<div class="middle-content">
							...
							<div id="owl-demo" class="owl-carousel text-center">
								...
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/timg3.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/timg4.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/timg5.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/timg6.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/timg7.jpg"
										alt="name">
								</div>
