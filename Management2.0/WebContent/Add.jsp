                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="registration.html" class=" hvr-bounce-to-right"><i class="fa fa-sign-in nav_icon"></i>Signup</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
  ...
  <div class="grid-form1">
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddCs" method="post">
							 <input type="hidden" name=userid value=<s:property value="user.userid"/>/>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Device ID</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquNumber">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Device name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquName">
									</div>
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">EquQua</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquQua">
									</div>
								</div>
						        ...
						        <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="ModelSpe">
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  class="form-control3"  id="datepicker"  name="EquDate">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquSta">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquClass">
									</div>
								</div>
								
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">EquUnit</label>
									<div class="col-sm-8"><select name="EquUnit" id="selector1" class="form-control1">
										<option>AI</option>
										<option>CS</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Manufacturer">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Supplier">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  class="form-control3"  id="datepicker1"  name="OrderDate">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Inspector">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Quality">
									</div>
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Maintainer</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Maintainer" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="InventoryPosition" >
									</div>
								</div>
							    ...
							    <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="PresentPosition" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="UnitPrice" >
									</div>
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">OrderQuantity</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="OrderQuantity" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Handler" >
									</div>
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">extra</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="extra" >
									</div>
								</div>
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2">
										...
										<s:a href="LendButton?userid=%{user.id}&EquNumber=%{EquNumber}"><input type="button" value="reset" class="btn-inverse btn"></s:a>
