  ...
  <div class="grid-form1">
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="ExamAdd" method="post" >
							 	<input type="hidden" name=userid value=<s:property value="user.userid"/> /> 

								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">体检信息ID</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="exam_id">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">姓名</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="patientname">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  class="form-control3"  id="focusedinput"  name="age">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="datepicker" name="time">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="(cm)" name="height">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="(kg)" name="weight">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="(次/分钟)" name="pulserate">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="(mmHg)" name="bloodpressure">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  class="form-control3"  id="focusedinput" placeholder="(%)" name="spo">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="(℃)" name="temperature">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="15/20/25"  name="bwh">
									</div>
								</div>
